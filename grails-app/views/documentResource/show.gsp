...
<html>
    ...
    <body>
        ...
        <div id="show-documentResource" class="content scaffold-show" role="main">
            ...
            <f:display bean="documentResource" />
            <g:form resource="${this.documentResource}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.documentResource}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
