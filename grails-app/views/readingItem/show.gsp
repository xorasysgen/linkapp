...
<html>
    ...
    <body>
        ...
        <div id="show-readingItem" class="content scaffold-show" role="main">
            ...
            <f:display bean="readingItem" />
            <g:form resource="${this.readingItem}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.readingItem}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
