...
<html>
    ...
    <body>
        <a href="#create-linkResource" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
        ...
        <div id="create-linkResource" class="content scaffold-create" role="main">
            ...
            <g:form resource="${this.linkResource}" method="POST">
                <fieldset class="form">
                    <f:all bean="linkResource" except="readingItems"/>
                </fieldset>
